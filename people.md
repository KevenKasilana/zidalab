...
<div id="people-section">
    <div id="heading"><h2>Graduate Students</h2></div>
	<div id="profile-image">
        <img src="./assets/images/profiles/Meichi.jpg" width = "150" height="210">
	</div>
	<div id="profile-content">
        <p>
        ...
        <p>
            ...
            <br>Email: 2017222079 AT email.szu.edu.cn
        </p>
        <p>
    ...
    <div id="profile-image">
        <img src="./assets/images/profiles/Jingyi.jpg" width = "150" height="210">
    </div>
    <div id="profile-content">
        <p>
        ...
        <p>
            Address: Bldg A2, Xili Campus
			<br>Email: dingjy99 AT 163.com
        </p>
		<p>
            <strong><u>Academic Training</u></strong><br>
			B.S., Biomedical Engineering, Shenzhen University (2017-2021)
			<br>University of California, Berkeley, Exchange program (Jan. 2020-June 2020)
        </p>
	</div>
    <div id="profile-image">
        <img src="./assets/images/profiles/Zhantao.jpg" width = "150" height="210">
    </div>
    <div id="profile-content">
        <p>
    ...
    <div id="profile-image">
        <img src="./assets/images/profiles/Fangqi.jpg" width = "150" height="210">
	</div>
    <div id="profile-content">
        <p>
...
<div id = "people-section">
    ...
    <div id="profile-content">
		<p>
			...
			<br>PhD Candidate, co-advised by Prof. Tianfu Wang (2019-2020)
        </p>
